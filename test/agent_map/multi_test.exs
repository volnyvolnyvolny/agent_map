defmodule AgentMapMultiTest do
  ...
  test "Multi.get(…, …, …, !: :now)" do
    ...
    am =
      ...
      |> sleep(:b, 50)
      |> put(:b, 24)
      |> Multi.get([:a, :b, :c, :d], & &1, !: :now) == [42, 1, 4, nil]
  ...
  test "Multi.get(…, …, …)" do
    am =
      ...
      |> sleep(:b, 20)
      |> put(:b, 24)
      |> Multi.get([:a, :b, :c, :d], & &1) == [24, 24, 4, nil]
  end
  ...
  test "Multi.get_and_update" do
    ...
    assert Multi.get_and_update(am, [:a, :b, :c, :d], &{&1}, !: :max) == [24, 24, 4, nil]
    assert Multi.get_and_update(am, [:a, :b, :c, :d], &{&1}, !: :max) == [33, 33, 4, nil]
